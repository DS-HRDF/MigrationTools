...
public class CEDAO {
    ...
    public void createClassFromJson(String classJson) {
        ...
        docClassList.getDocClassList().stream().forEach(c -> {
            ...
            try {
                ...
                ClassDefinition subclass = parentClass.createSubclass();
                ...
                c.getTemplateList().stream().forEach(propTemplate ->
                {
                    ...
                    try {
                        CreateAndAddProperty(getObjectStore(), subclass, propTemplate.getCode(), propTemplate.getDataType());
                    } catch (Exception e) {
                        e.printStackTrace();
    ...
    public void CreateAndAddProperty(ObjectStore objStore, ClassDefinition classDef, String propertyName, String type) {
        ...
        SharedPropTemplate temp = get_Shared_PropertyDefinition(propertyName);
