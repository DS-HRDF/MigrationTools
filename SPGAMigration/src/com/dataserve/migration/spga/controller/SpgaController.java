...
//    static List<Thread> threads = new ArrayList<>();
    ...
    public SpgaController() throws IOException {
        ...
        TableColumn migratedDocId = new TableColumn("migratedDocId");
        ...
        migratedDocId.setCellValueFactory(
                new PropertyValueFactory<>("migratedDocId")
        );
        DataTbl.getColumns().addAll(CNClmn, HYClmn, typeIDClmn, docidClmn, fileNameClmn, docTitleClmn, classIdClmn, mimeTypeClmn,
                createDateClmn, usernameClmn, statusClmn, messageClmn,migratedDocId);
