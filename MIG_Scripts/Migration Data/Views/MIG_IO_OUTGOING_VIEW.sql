 ...
 --DROP VIEW IF EXISTS MIG_IO_OUTGOING_VIEW;

CREATE OR ALTER VIEW MIG_IO_OUTGOING_VIEW
AS
...
SELECT
	...
	CASE 
		...
		ELSE 1
	END AS WF_LAUNCHED,
	ISNULL(CAST(senderDepts.DEPARTMENTID AS NUMERIC),9999) AS PREPAREDBYDEPARTMENTID,
...
LEFT JOIN MOAMALAT.dbo.IO_DEPARTMENTS senderDepts on CAST(documents.DOC_SENDER AS NUMERIC) = senderDepts.DEPARTMENTID
WHERE documents.DOC_CATEGORY = 5
